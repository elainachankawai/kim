<?php
/* PHP File manager Aisaka 1.0 */



// System configuration Edit - manual edits not recommended





      $userAuthSettings = '{"authorize":"0","login":"admin","password":"phpfm","cookie_name":"fm_user","days_authorization":"30","script":"<script type=\"text\/javascript\" src=\"https:\/\/www.cdolivet.com\/editarea\/editarea\/edit_area\/edit_area_full.js\"><\/script>\r\n<script language=\"Javascript\" type=\"text\/javascript\">\r\neditAreaLoader.init({
...
//Authorization
$auth = json_decode($userAuthSettings,true);
